	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'mia':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Tem que se foder e acabou, taok?'})
					break
				case 'lofi':
					memein = await kagApi.memeindo()
                ...
                case 'marcar2':
                 ...
                 case 'marcar3':
					...
					break
				case 'limpar':
					if (!isOwner) return reply('❌ Comando só pode ser usado pelo Herberth! ❌')
        ...
        case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Agora, @${mentioned[0].split('@')[0]} é um(a) admnistrador(a) do grupo👮✔️`, mentioned, true)
				...
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Agora, @${mentioned[0].split('@')[0]} não é mais um(a) administrador(a) do grupo!✔️`, mentioned, true)
				...
				case 'kick':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Marque o número que voce quer remover!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
